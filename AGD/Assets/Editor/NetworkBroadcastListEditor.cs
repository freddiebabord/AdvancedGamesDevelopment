...
{
    [CustomEditor(typeof(NetworkBroadcastList), true)]
    [CanEditMultipleObjects]
    public class NetworkBroadcastListEditor : Editor
    {
        bool m_Initialized;
        NetworkBroadcastList m_Discovery;
        ...
        SerializedProperty m_ipHolderContentRect;
        SerializedProperty m_templateButton;
        SerializedProperty m_buttonMinWidth;
        ...
        GUIContent m_BroadcastListHolderLabel;
        GUIContent m_broadcastTemplateButtonLabel;
        ...
        void Init()
        {
            ...
            m_Initialized = true;
            m_Discovery = target as NetworkBroadcastList;
            ...
            m_ipHolderContentRect = serializedObject.FindProperty("ipHolderContectRect");
            m_templateButton = serializedObject.FindProperty("templateButton");
            ...
            m_BroadcastListHolderLabel = new GUIContent("IP Holder Rect", "The rect transform that stores the list of ip adress buttons");
            m_broadcastTemplateButtonLabel = new GUIContent("IP Template Button", "The tmeplate for the ip button");
        }
        ...
        void DrawControls()
        {
            ...
            EditorGUILayout.PropertyField(m_ShowGUIProperty);
            if (m_Discovery.showGUI)
            {
                EditorGUILayout.PropertyField(m_OffsetXProperty);
                EditorGUILayout.PropertyField(m_OffsetYProperty);
            }
            ...
            EditorGUILayout.LabelField("Find A Game Section");
            EditorGUILayout.PropertyField(m_ipHolderContentRect, m_broadcastTemplateButtonLabel);
            EditorGUILayout.PropertyField(m_templateButton, m_broadcastTemplateButtonLabel);
        }
    }
}
#endif