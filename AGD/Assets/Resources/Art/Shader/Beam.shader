...
////// Lighting:
////// Emissive:
                float3 emissive = ((saturate(pow((1.0 - abs((i.uv0.g*2.0+-1.0).r)),_WidthPower))*_Colour.rgb)*_Intensity);
