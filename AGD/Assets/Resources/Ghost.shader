...
/*SF_DATA;ver:1.29;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:3,spmd:0,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:True,rprd:True,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:0,dpts:2,wrdp:False,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:2865,x:32978,y:32731,varname:node_2865,prsc:2|emission-3537-OUT;n:type:ShaderForge.SFN_Multiply,id:2837,x:32354,y:32576,varname:node_2837,prsc:2|A-6202-RGB,B-4127-OUT;n:type:ShaderForge.SFN_Multiply,id:4127,x:31962,y:32639,varname:node_4127,prsc:2|A-1173-RGB,B-7453-OUT;n:type:ShaderForge.SFN_Fresnel,id:7453,x:31755,y:32743,varname:node_7453,prsc:2|EXP-8509-OUT;n:type:ShaderForge.SFN_Slider,id:8509,x:31318,y:32819,ptovrint:False,ptlb:Edge Blend,ptin:_EdgeBlend,varname:node_8509,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:2.5,max:5;n:type:ShaderForge.SFN_Color,id:1173,x:31692,y:32575,ptovrint:False,ptlb:Colour,ptin:_Colour,varname:node_1173,prsc:2,glob:False,taghide:False,taghdr:True,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0,c3:0,c4:0;n:type:ShaderForge.SFN_Tex2d,id:6202,x:32128,y:32441,ptovrint:False,ptlb:Texture,ptin:_Texture,varname:node_6202,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:a181ca8e3c62f3e4b8f183f6c586b032,ntxv:2,isnm:False|UVIN-3323-UVOUT;n:type:ShaderForge.SFN_Panner,id:3323,x:31941,y:32117,varname:node_3323,prsc:2,spu:1,spv:1|UVIN-7718-UVOUT,DIST-9666-OUT;n:type:ShaderForge.SFN_TexCoord,id:7718,x:31670,y:32108,varname:node_7718,prsc:2,uv:0;n:type:ShaderForge.SFN_Multiply,id:9666,x:31755,y:32312,varname:node_9666,prsc:2|A-475-T,B-2964-OUT;n:type:ShaderForge.SFN_Time,id:475,x:31405,y:32217,varname:node_475,prsc:2;n:type:ShaderForge.SFN_Slider,id:2964,x:31224,y:32461,ptovrint:False,ptlb:Pan Speed,ptin:_PanSpeed,varname:_Intensity_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.1,max:1;n:type:ShaderForge.SFN_DepthBlend,id:6719,x:32066,y:32810,varname:node_6719,prsc:2|DIST-1061-OUT;n:type:ShaderForge.SFN_ValueProperty,id:1061,x:31737,y:32981,ptovrint:False,ptlb:DepthBelnd,ptin:_DepthBelnd,varname:node_1061,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Multiply,id:3537,x:32617,y:32848,varname:node_3537,prsc:2|A-673-OUT,B-6719-OUT;n:type:ShaderForge.SFN_Multiply,id:1105,x:32122,y:33024,varname:node_1105,prsc:2|A-1173-RGB,B-9201-OUT;n:type:ShaderForge.SFN_ValueProperty,id:9201,x:31863,y:33171,ptovrint:False,ptlb:SoftColour,ptin:_SoftColour,varname:node_9201,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.2;n:type:ShaderForge.SFN_Lerp,id:673,x:32394,y:32964,varname:node_673,prsc:2|A-1105-OUT,B-1173-RGB,T-7453-OUT;proporder:8509-1173-6202-2964-1061-9201;pass:END;sub:END;*/
...
////// Emissive:
                ...
                float3 emissive = (lerp((_Colour.rgb*_SoftColour),_Colour.rgb,node_7453)*saturate((sceneZ-partZ)/_DepthBelnd));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_7453 = pow(1.0-max(0,dot(normalDirection, viewDirection)),_EdgeBlend);
                o.Emission = (lerp((_Colour.rgb*_SoftColour),_Colour.rgb,node_7453)*saturate((sceneZ-partZ)/_DepthBelnd));
