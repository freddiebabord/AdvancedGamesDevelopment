...
[FIX] - Fixed a bug in some build configurations like Microsoft Hololens that gave
        a compiler error.

V1.20 - 31/05/2016:

[FIX] - Fixed a memory leak when using breakable procedural ropes that created many
        memory allocations and garbage collector calls.
